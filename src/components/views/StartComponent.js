                        ...
                        <div className="backi">
                            ...
                            <div className="commentsAndForm">
                                <div className="commentsWallHeadFrame">
                                    <div>
                                        {first.commento.length === 0 || !first.commento ?
                                            <div className="mt-2 ml-0">
                                                <h6 className="" >No comments yet.</h6>
                                            </div>
                                            :
                                            first.commento[0].length > 1 ?
                                                <div className="mt-2">
                                                    <h6 className="">There are {first.commento[0].length} comments.</h6>
                                                </div>
                                                :
                                                <div className="mt-2">
                                                    <h6 className="">There is {first.commento.length} comment.</h6>
                                                </div>
                                        }
